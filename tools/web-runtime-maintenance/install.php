...
if (str_contains($before,'pied-web-runtime-maintenance')) throw new RuntimeException('Exists');
...
$config->Set('plugins','enabled_list',$before.',pied-web-runtime-maintenance');
