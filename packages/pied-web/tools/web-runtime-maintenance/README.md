...
It only inspects/invalidates the fixed PHP payload of `pied-web-ux` and the fixed
NextSnapMail account-context files listed in `index.php`; it accepts no path.
