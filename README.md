...
- In Conversations mode, the newest received or sent message opens in the native reader; earlier messages are folded cards one click away, without storing extra copies.
...
Release **1.7.22**, tested with Nextcloud **34.0.4**, NextSnapMail **0.1.11**, embedded SnappyMail **2.38.2**. Other versions are unverified.
